...
// Ported from dsh-agy-link src/host/pool.ts @ 46984db (modified: the
// system-HOME primary-account paths are removed — bootstrapDefaultAccount /
...
export class AccountPoolManager {
  ...
  /**
   * Sweep agy CLI log files older than maxDays (default: 7) across all managed
   * account directories.
   */
