...
// catalog entries. Gemini slugs fold into a base model plus selectable
...
export function foldEfforts(raw: readonly RawModel[]): CatalogEntry[] {
  ...
  // the id and the /v1/models listing would then carry the same model twice.
...
// ---------------------------------------------------------------------------
// Catalog cache with TTL + stale-while-revalidate.
...
export function defaultEffortFor(entry: CatalogEntry, cfg: GatewayConfig): string | undefined {
